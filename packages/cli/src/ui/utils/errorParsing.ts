...
const RATE_LIMIT_ERROR_MESSAGE_ANTHROPIC =
  '\nPlease wait and try again later. To increase your limits, upgrade your Anthropic plan at https://console.anthropic.com/settings/plans, or switch to another /auth method';
...
function getRateLimitMessage(authType?: AuthType): string {
  switch (authType) {
    ...
    case AuthType.USE_ANTHROPIC_CLAUDE:
      return RATE_LIMIT_ERROR_MESSAGE_ANTHROPIC;
    default:
